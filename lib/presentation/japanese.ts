...
const KIND_LABELS: Record<string, string> = {
  ...
  Route: "輸送路",
  SeaLane: "海上輸送路",
  SecurityActivity: "安全保障活動",
  MissileTest: "ミサイル発射履歴",
  LaunchSite: "発射地点",
  ImpactArea: "落下・影響推定区域",
  MilitaryActivityRoute: "航空・海上活動経路",
  PublicAlertSignal: "公開警戒シグナル",
  RegionalSecurityObservation: "地域安全保障観測",
  SourceDocument: "出典文書",
  StrategicLayer: "横断Layer",
  Terminal: "受入基地",
  WorldRegion: "地域"
};
...
const ENTITY_LABELS: Record<string, string> = {
  ...
  "capability:base-hardening": "基地・施設抗たん性",
  "capability:munitions-stockpile": "弾薬・継戦備蓄",
  "capability:shipbuilding-sustainment": "造船・艦艇維持",
  ...
  "layer:defense-industrial-base": "防衛産業基盤Layer",
  "layer:strategic-autonomy": "戦略的自立性Layer",
  "airport:haneda": "東京国際空港（羽田）",
  "airport:narita": "成田国際空港",
  "activity:north-korea-missile-test-history": "北朝鮮ミサイル発射履歴",
  "activity-route:nk-missile-representative-arc": "北朝鮮ミサイル代表軌道",
  "activity-route:china-air-activity-east-china-sea-public": "東シナ海周辺の中国航空活動公開文脈",
  "impact-area:sea-of-japan": "日本海代表落下・影響推定区域",
  "launch-site:north-korea-representative": "北朝鮮代表発射地域",
  "org:mod": "防衛省",
...
const FLOW_LABELS: Record<string, string> = {
  ...
  "flow:defense-industrial-base-hardening": "防衛産業基盤 → 基地・施設抗たん性",
  "flow:defense-industrial-base-munitions": "防衛産業基盤 → 弾薬・継戦備蓄",
  "flow:defense-industrial-base-shipbuilding": "防衛産業基盤 → 造船・艦艇維持",
  "flow:energy-inputs-rice": "エネルギー・肥料投入 → コメ価格",
  "flow:japan-linked-maritime-watch": "一般貨物・港湾後続 → 首都圏",
  ...
  "flow:nk-missile-history-japan-watch": "北朝鮮ミサイル履歴 → 日本周辺",
...
const OBSERVATION_LABELS: Record<string, string> = {
  ...
  "observation:capital-lifeline-watch-2026": "首都圏ライフライン複合監視",
  "observation:lng-electricity-april-2026": "LNGと電気代への影響シグナル",
  "observation:nk-missile-history-watch": "北朝鮮ミサイル履歴の公開監視",
  "observation:china-air-activity-public-watch": "中国航空活動の公開集約監視",
...
const SUMMARY_LABELS: Record<string, string> = {
  ...
  "flow:nk-missile-history-japan-watch": "北朝鮮ミサイル発射履歴を、日本周辺の公共安全・海空域文脈へ接続する非ライブの地域安全保障フロー。",
  ...
  "flow:defense-industrial-base-hardening": "防衛産業基盤を、基地・施設抗たん性という国内インフラ側の能力へ接続する橋渡しフロー。",
  "flow:defense-industrial-base-munitions": "防衛産業基盤を、弾薬・継戦備蓄という継続能力へ接続する橋渡しフロー。",
  "flow:defense-industrial-base-shipbuilding": "防衛産業基盤を、造船・艦艇維持という海洋国家側の産業能力へ接続する橋渡しフロー。",
  "layer:defense-industrial-base": "防衛を単なる予算項目ではなく、造船、弾薬、基地抗たん性、無人化を束ねる産業基盤として読むための横断Layer。",
  "layer:strategic-autonomy": "エネルギー、食料、水、防衛、半導体、物流を、どれだけ自前で耐えられるかという同じ物差しで読むための横断Layer。",
  ...
  "observation:capital-lifeline-watch-2026": "気象庁の地震情報発表導線と首都圏の水資源監視を重ね、東京湾着地のライフライン監視を bounded な形で見せる複合シグナル。",
  "observation:nk-missile-history-watch": "北朝鮮ミサイル発射履歴を、日本向けの地域安全保障文脈として公開・履歴・集約単位で読むシグナル。",
  "observation:china-air-activity-public-watch": "中国関連の航空活動を、統合幕僚監部などの公開発表に基づく集約文脈として扱うシグナル。個別機体やライブ追跡ではない。",
...
const SOURCE_LABELS: Record<string, string> = {
  ...
  "source:jma-earthquake-information": "気象庁: 地震情報について",
  ...
  "source:cns-north-korea-missile-test-database": "CNS/NTI: North Korea Missile Test Database",
  "source:nagix-nk-missile-tests": "GitHub: nagix/nk-missile-tests",
  "source:mod-dprk-missile-nuclear-development": "防衛省: 北朝鮮による核・弾道ミサイル開発について",
  "source:mod-joint-staff-air-activity": "統合幕僚監部: 報道発表資料",
  "source:tepco-2026-april-power": "東京電力EP: 2026年4月分電気料金のお知らせ"
};

const PUBLISHER_LABELS: Record<string, string> = {
  "Center for Nonproliferation Studies / NTI": "CNS / NTI",
  "James Martin Center for Nonproliferation Studies": "James Martin Center for Nonproliferation Studies",
  "Ministry of Agriculture, Forestry and Fisheries": "農林水産省",
  "Ministry of Defense": "防衛省",
  "nagix / GitHub": "nagix / GitHub",
  "防衛省": "防衛省",
  "防衛省 統合幕僚監部": "防衛省 統合幕僚監部",
